...
@pushonce('scriptCustom')
    <script type="text/javascript">
        function loadProduct(){
            ...
            $.ajax({
                url         : '{{ route("admin.trainer.loadProduct") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
        ...
        function chooseProduct(idBox) {
            ...
            $.ajax({
                url         : '{{ route("admin.trainer.chooseProduct") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
        ...
        function loadThemeProductChoosed(){
            $.ajax({
                url         : '{{ route("admin.trainer.loadThemeProductChoosed") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
                    // product_info_id : idProduct,
        ...
        function removeOneProductChoosed(idProduct){
            $.ajax({
                url         : '{{ route("admin.trainer.removeOneProductChoosed") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
                    product_info_id : idProduct,
        ...
        function clearProductChoosed(){
            $.ajax({
                url         : '{{ route("admin.trainer.clearProductChoosed") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
                    // product_info_id : idProduct,
        ...
        function getListProductChoose() {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url         : '{{ route("admin.trainer.getListProductChoose") }}',
                    type        : 'get',
                    dataType    : 'json',
        ...
        function callAIWritePerProduct(product_info_id, wallpapers, title_input) {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url         : '{{ route("admin.trainer.callAIWritePerProduct") }}',
                    type        : 'get',
