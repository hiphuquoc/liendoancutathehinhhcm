...
@push('cssFirstView')
    ...
    @if(env('APP_ENV')=='local')
        @vite('resources/sources/main/aboutus-first-view.scss')
    @else
        @php
            $manifest           = json_decode(file_get_contents(public_path('build/manifest.json')), true);
            $cssFirstView       = $manifest['resources/sources/main/aboutus-first-view.scss']['file'];
        @endphp
        <style type="text/css">
...
@section('content')
    ...
    @include('wallpaper.aboutus.content')
