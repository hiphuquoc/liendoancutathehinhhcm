...
<div class="adminContentPage">
    <div class="adminContentPage_content">
        <div class="companyManagementPage_section companyManagementPage_section--tracked">
            <div class="companyManagementPage_section_header companyManagementPage_section_header--page">
                <div class="companyManagementPage_section_header_left">
                    <div class="companyManagementPage_section_header_iconWrapper companyManagementPage_section_header_iconWrapper--page">
                    ...
                    <div class="companyManagementPage_section_header_info">
                        ...
                        <p class="companyManagementPage_section_desc">Quản lý các trang trong hệ thống</p>
                    </div>
                </div>
            ...
            <div class="companyManagementPage_section_body">
                <!-- Search Bar -->
                <form id="formSearch" method="get" action="{{ route('admin.page.list') }}" class="adminContentPage_searchBar">
                    ...
                    @foreach($list as $item)
                            ...
                            <div class="adminContentPage_card" id="oneItem-{{ $item->id }}">
                                <div class="adminContentPage_card_imageWrapper">
                                    <img src="{{ $urlImage }}?v={{ time() }}" alt="{{ $item->seo->title ?? 'Trang' }}" />
                                    <div class="adminContentPage_card_actions">
                                        ...
                                        <a href="{{ route('admin.page.view', ['language' => 'vi', 'id' => $item->id]) }}" class="adminContentPage_card_action" title="Chỉnh sửa">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        ...
                                        @if(auth()->user()->hasRole('admin'))
                                            <a href="{{ route('admin.page.view', ['id' => $item->id, 'language' => 'vi', 'type' => 'copy']) }}" class="adminContentPage_card_action" title="Sao chép">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                @else
                    <div class="adminContentPage_empty">
                        ...
                        <p>Hãy thêm trang mới vào hệ thống</p>
                    </div>
                @endif
            </div>
        </div>
...
<!-- Nút thêm -->
<a href="{{ route('admin.page.view') }}" class="adminContentPage_addButton">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
