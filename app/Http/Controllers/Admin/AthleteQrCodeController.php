...
class AthleteQrCodeController extends Controller
{
    ...
    {
        return QrCodeZipExportService::TYPE_ATHLETE;
    }
    ...
    public function deleteSelected(Request $request)
    {
        ...
        $result = app(ProfileDeletionService::class)->deleteMany(ProfileDeletionService::TYPE_ATHLETE, $ids);
        ...
        return response()->json([
            ...
            'message' => $failedCount === 0
                ? "Đã xóa {$deletedCount} hồ sơ vận động viên."
