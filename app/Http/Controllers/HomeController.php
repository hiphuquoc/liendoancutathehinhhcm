...
class HomeController extends Controller {
    ...
    public static function qrcodeTT(Request $request){
        // Đường dẫn file trong thư mục storage
        $filePath = Storage::path('public/danh-sach-tt-new.xlsx'); // Thay "your-folder" bằng tên thư mục trong storage
        ...
        foreach ($sheet as $index => $row) {
            ...
            $trainers[] = [
                ...
                'phone' => $row[4] ?? '',   
                'address' => $row[5] ?? '', 
                'link'      => 'https://liendoancutathehinhhcm.com.vn/trong-tai/'.$slug,
            ];
        }
