...
<div class="titlePage">Danh Sách Tài Liệu</div>
<!-- ===== START: SEARCH FORM ===== -->
<form id="formSearch" method="get" action="{{ route('admin.document.list') }}">
    <div class="searchBox">
        ...
        <div class="searchBox_item" style="margin-left:auto;text-align:right;">
            @php
                $xhtmlSettingView   = \App\Helpers\Setting::settingView('viewDocumentInfo', config('setting.admin_array_number_view'), $viewPerPage, $list->total());
