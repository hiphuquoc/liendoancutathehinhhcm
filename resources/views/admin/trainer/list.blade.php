    ...
    <div class="adminPersonnelPage_content">
        <div class="companyManagementPage_section companyManagementPage_section--tracked">
                ...
                <div class="companyManagementPage_section_header_right">
                    <div class="adminPersonnelPage_stats">
                        ...
                        <div class="adminPersonnelPage_stats_item adminPersonnelPage_stats_viewPerPage">
                            ...
                            <select class="adminPersonnelPage_stats_viewPerPage_select" onchange="settingView('viewTrainerInfo', this.value);">
            ...
            <div class="companyManagementPage_section_body">
                <!-- Search & Filter Bar -->
                <form id="formSearch" method="get" action="{{ route('admin.trainer.list') }}" class="adminPersonnelPage_searchBar">
                                ...
                                <div class="adminPersonnelPage_card" id="oneItem-{{ $item->id }}">
                                    <div class="adminPersonnelPage_card_header">
                                        ...
                                        <div class="adminPersonnelPage_card_actions">
                                            ...
                                            <a href="{{ route('admin.trainer.view', ['language' => 'vi', 'id' => $item->id]) }}" class="adminPersonnelPage_card_action" title="Chỉnh sửa">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            ...
                                            @if(auth()->user()->hasRole('admin'))
                                                <a href="{{ route('admin.trainer.view', ['id' => $item->id, 'language' => 'vi', 'type' => 'copy']) }}" class="adminPersonnelPage_card_action" title="Sao chép">
                                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <div class="adminPersonnelPage_card_body">
                                        ...
                                        @if(!empty($item->trainer_code))
                                            <div 
                                                class="adminPersonnelPage_card_code adminPersonnelPage_card_code--clickable"
                                                onclick="copyTrainerCode('{{ $item->trainer_code }}', this)"
                                                data-tooltip="Nhấp để sao chép mã HLV"
                                                title="Nhấp để sao chép mã HLV"
                                            >
                                                <span class="adminPersonnelPage_card_code_text">{{ $item->trainer_code }}</span>
...
<script type="text/javascript">
    function deleteItem(id){
        if(confirm('{{ config("admin.alert.confirmRemove") }}')) {
            $.ajax({
                url         : "{{ route('admin.trainer.delete') }}",
                type        : "get",
                dataType    : "html",
                data        : { id : id }
            }).done(function(data){
