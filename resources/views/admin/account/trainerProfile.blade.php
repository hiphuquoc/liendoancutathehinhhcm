                        ...
                        <div class="adminFormSection_body">
                            <div class="adminFormGrid adminFormGrid--3cols">
                                @include('admin.components.formField', [
                                    ...
                                    'name' => 'total_learner',
                                    'type' => 'number',
                                    'value' => old('total_learner') ?? ($trainer->total_learner ?? 0),
                                    'required' => false
                                ])
                                @include('admin.components.formField', [
                                    'label' => 'Giờ dạy',
                                    ...
                                    'type' => 'number',
                                    'value' => old('total_teaching_hour') ?? ($trainer->total_teaching_hour ?? 0),
                                    'required' => false
                                ])
                                @include('admin.components.formField', [
                                    'label' => 'Giải thưởng',
                                    'name' => 'total_prize',
                                    'type' => 'number',
                                    'value' => old('total_prize') ?? ($trainer->total_prize ?? 0),
                                    'required' => false,
                    ...
                    <div class="adminFormSection">
                        ...
                        <div class="adminFormSection_body">
                            @include('admin.components.activityImagesUpload', [
                                'activityImages' => $trainer->activityImages ?? collect(),
