                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <a href="index.html" class="brand-logo">
                            ...
                            <h2 class="brand-text text-primary ms-1">Liên đoàn</h2>
                        </a>
                        ...
                        <p id="js_noticeLogin" class="card-text mb-2" style="color:red;"></p> <!-- lỗi -->
                        <form id="formLogin" class="auth-login-form mt-2" method="GET">
                            <div class="mb-1">
                            ...
                            <button class="btn btn-primary w-100 waves-effect waves-float waves-light" tabindex="4" aria-label="Đăng nhập" onClick="submitFormLogin('formLogin')">Đăng nhập</button>
                        </form>
                        ...
                        <div class="auth-footer-btn d-flex justify-content-center" style="margin-top:20px;">
