...
class TrainerController extends Controller {
    ...
    public function list(Request $request){
        ...
        return view('admin.trainer.list', compact('list', 'categories', 'params', 'viewPerPage'));
    }
    ...
    public function view(Request $request){
        ...
        if($flagView==true){
            ...
            /* category cha */
            return view('admin.trainer.view', compact('item', 'itemSeo', 'itemSourceToCopy', 'itemSeoSourceToCopy', 'prompts', 'type', 'language', 'sources', 'parents', 'message'));
        } else {
    ...
    public function createAndUpdate(Request $request){
        ...
        return redirect()->route('admin.trainer.view', ['id' => $idBlog, 'language' => $language]);
    }
    ...
    public function loadProduct(Request $request){
        ...
        foreach($products as $product){
            $response       .= view('admin.trainer.itemProduct', compact('product'))->render();
        }
        echo $response;
    }
    ...
    public function loadThemeProductChoosed(){
        ...
        if(!empty($products)){
            foreach($products as $product){
                ...
                $response       .= view('admin.trainer.itemProductChoosed', compact('product', 'wallpaperIds'))->render();
            }
        }
